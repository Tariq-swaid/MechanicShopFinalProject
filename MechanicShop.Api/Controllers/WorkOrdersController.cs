...
using MechanicShop.Application.Common.Fetures.Shceduling.Quries.GetDailyScheduleQuery;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.AssignLabor;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.CreateWorkOrder;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.DeleteWorkOrder;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.RelocateWorkOrder;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.UpdateOrderState;
using MechanicShop.Application.Common.Fetures.WorkOrders.Command.UpdateWorkOrderRepairTasks;
using MechanicShop.Application.Common.Fetures.WorkOrders.Dtos;
using MechanicShop.Application.Common.Fetures.WorkOrders.Queries.GetWorkOders;
using MechanicShop.Application.Common.Fetures.WorkOrders.Queries.GetWorkOrderByIdQuery;
...
namespace MechanicShop.Api.Controllers
{
    ...
    {
        [HttpGet]
        [ProducesResponseType(typeof(PaginatedList<WorkOederListItemDto>), StatusCodes.Status200OK)]
        ...
        [ProducesResponseType(typeof(WorkOrdersDto), StatusCodes.Status200OK)]
        ...
        [ProducesResponseType(typeof(WorkOrdersDto), StatusCodes.Status201Created)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status400BadRequest)]
        [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status500InternalServerError)]
