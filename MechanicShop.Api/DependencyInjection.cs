...
using MechanicShop.Api.Service;
...
namespace MechanicShop.Api
{
    public static class DependencyInjection
    {
        ...
        {
            // 1. Configure the base API Versioning
            ...
            // 2. Configure the Versioned API Explorer (Break the chain!)
        ...
        public static IServiceCollection AddControllerWithJsonConfiguration(this IServiceCollection services)
        {
            ...
            {
                // 1. الخيار القديم الخاص بك (اتركه كما هو)
                options.JsonSerializerOptions.DefaultIgnoreCondition = JsonIgnoreCondition.WhenWritingNull;

                // 2. السطر الجديد الذي سيحل مشكلة الـ Failed to load response data نهائياً
