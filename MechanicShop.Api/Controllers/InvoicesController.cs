...
using MechanicShop.Application.Common.Fetures.Biling.Commands.IssueInvoice;
using MechanicShop.Application.Common.Fetures.Biling.Commands.SettleInvoice;
using MechanicShop.Application.Common.Fetures.Biling.Dtos;
using MechanicShop.Application.Common.Fetures.Biling.Queries.GetInvoiceById;
using MechanicShop.Application.Common.Fetures.Biling.Queries.GetInvoicePdf;
using MediatR;
...
namespace MechanicShop.Api.Controllers
{
    ...
    public class InvoicesController(ISender sender): ApiController
    {
        ...
        {
            var result = await _sender.Send(new GetInvoiceByIdQery(invoiceId), ct);
