...
namespace MechanicShop.Client.Services
{
    public class ServiceApi(IHttpClientFactory httpClientFactory, TimeZoneService timeZoneService)
    {
        ...
        public async Task<ApiResult<List<CustomerModel>>> GetCustomersAsync()
        {
            ...
            {
                return await HandleExceptionAsync<List<CustomerModel>>(ex, "Failed to retrieve customers. Please try again.");
            }
        }
        ...
        public async Task<ApiResult<CustomerModel>> GetCustomerAsync(Guid CustomerId)
        {
            try
            {
                ...
                if (response.IsSuccessStatusCode)
                {
                    ...
                    return ApiResult<CustomerModel>.Success(customer ?? new CustomerModel());
                }
                return await HandleErrorResponseAsync<CustomerModel>(response);
            }
            catch (Exception ex)
            {
                return await HandleExceptionAsync<CustomerModel>(ex, $"Failed to retrieve customer with ID {CustomerId}. Please try again.");
            }
        }
        ...
        public async Task<ApiResult<CustomerModel>> CreateCustomerAsync(CreateCustomerRequest request)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync<CustomerModel>(response, "Access Denied: Only managers can create new customers.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult<CustomerModel>> UpdateCustomerAsync(Guid customerId, UpdateCustomerRequest request)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync<CustomerModel>(response, "Access Denied: Only managers can update customer details.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult> DeleteCustomerAsync(Guid customerId)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can delete customers.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult<List<LaborModel>>> GetLaborsAsync()
        {
            ...
            {
                return await HandleExceptionAsync<List<LaborModel>>(ex, "Failed to retrieve labors. Please try again.");
            }
        }
        ...
        public async Task<ApiResult<List<RepairTaskModel>>> GetRepairTasksAsync()
        {
            ...
            {
                return await HandleExceptionAsync<List<RepairTaskModel>>(ex, "Failed to retrieve repair tasks. Please try again.");
            }
        }
        ...
        public async Task<ApiResult<RepairTaskModel>> CreateRepairTaskAsync(CreateRepairTaskRequest request)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync<RepairTaskModel>(response, "Access Denied: Only managers can create repair tasks.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult<RepairTaskModel>> UpdateRepairTaskAsync(Guid repairTaskId, UpdateRepairTaskRequest request)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync<RepairTaskModel>(response, "Access Denied: Only managers can update repair tasks.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult> DeleteRepairTaskAsync(Guid repairTaskId)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can delete repair tasks.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult<WorkOrderModel>> GetWorkOrderByIdAsync(Guid WorkOrderId)
        {
            ...
            {
                return await HandleExceptionAsync<WorkOrderModel>(ex, $"Failed to retrieve work order with ID {WorkOrderId}. Please try again.");
            }
        }

        public async Task<ApiResult> CreateWorkOrderAsync(CreateWorkOrderRequest request)
        {
            try
            {
                var response = await _httpClient.PostAsJsonAsync("api/v1/WorkOrders", request);
                if (response.IsSuccessStatusCode)
                {
                    return ApiResult.Success();
                }
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can create work orders.");
            }
            catch (Exception ex)
            {
                return await HandleExceptionAsync(ex, "Failed to create work order. Please try again.");
            }
        }
        ...
        public async Task<ApiResult> RelocateWorkOrderAsync(Guid WorkOrderId, RelocateWorkOrderRequest request)
        {
            try
            {
                var response = await _httpClient.PutAsJsonAsync($"api/v1/WorkOrders/{WorkOrderId}/relocate", request);
                if (response.IsSuccessStatusCode)
                {
                    return ApiResult.Success();
                }
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can relocate work orders.");
            }
            catch (Exception ex)
            {
                return await HandleExceptionAsync(ex, $"Failed to relocate work order with ID {WorkOrderId}. Please try again.");
            }
        }
        ...
        public async Task<ApiResult> UpdateWorkOrderLaborAsync(Guid workOrderId, AssignLaborRequest laborUpdateRequest)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can assign labor.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult> DeleteWorkOrderAsync(Guid workOrderId)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can delete work orders.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult<InvoiceModel>> IssueInvoiceAsync(Guid workorderId)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync<InvoiceModel>(response, "Access Denied: Only managers can issue invoices.");
            }
            catch (Exception ex)
            {
        ...
        public async Task<ApiResult> SettleInvoice(Guid invoiceId)
        {
            try
            {
                ...
                return await HandleErrorResponseAsync(response, "Access Denied: Only managers can settle invoices.");
            }
            catch (Exception ex)
            {
        ...
        private static async Task<ApiResult<T>> HandleErrorResponseAsync<T>(HttpResponseMessage response, string? forbiddenMessage = null)
        {
            if (response.StatusCode == HttpStatusCode.Forbidden)
            {
                return ApiResult<T>.Failure(
                    message: forbiddenMessage ?? "Access Denied: You do not have permission to perform this action.",
        ...
        // FIXED: Added <object> explicitly so the compiler can infer types properly
        private static Task<ApiResult> HandleErrorResponseAsync(HttpResponseMessage response, string? forbiddenMessage = null) =>
            HandleErrorResponseAsync<object>(response, forbiddenMessage)
                .ContinueWith(t =>
                    ApiResult.Failure(
